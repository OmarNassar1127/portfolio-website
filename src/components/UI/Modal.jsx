  ...
  return (
    ...
    >
      <div
        ...
        className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5 max-h-[80vh] overflow-y-auto"
      >
        <button
          onClick={handleCloseModal}
          className="w-[1.8rem] h-[1.8rem] bg-primaryColor text-white sticky top-[1.76rem] left-[50rem] text-[25px] flex items-center justify-center rounded-[3px] leading-0 cursor-pointer"
        >
          &times;
        </button>
        <div>
