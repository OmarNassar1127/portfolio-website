...
const Journey = ({ language }) => {
  ...
  const text4 =
    language === "EN"
      ? "During my time at CSDM, I served as a frontend developer, utilizing ReactJS and myGraphQL to develop web applications. Through my internship experience, I gained valuable insight into the workings of a company. Following my graduation, I took on more significant responsibilities, designing and implementing features for high-profile clients such as CocaCola, Shell, and Schiphol, to name a few."
      : "Tijdens mijn tijd bij CSDM werkte ik als Frontend-ontwikkelaar en maakte ik gebruik van ReactJS en myGraphQL voor het ontwikkelen van webapplicaties. Door mijn stage-ervaring kreeg ik waardevol inzicht in hoe een bedrijf werkt. Na mijn afstuderen nam ik meer verantwoordelijkheden op me en ontwierp en implementeerde ik functies voor grote klanten zoals CocaCola, Shell en Schiphol, om er een paar te noemen.";
  const text5 =
    language === "EN"
